...
const {createProduct,productsList,singleProduct,deleteProduct,updateProduct,
    filterProducts,outOfStock,sorting,search} = require ("../Controller/productController");
